...
public class GLSurfaceViewAPI18 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    /**
     * Log GL calls to the system log at "verbose" id with tag "GLSurfaceView".
     *
     * @see #getDebugFlags
     * @see #setDebugFlags
     */
     ...
     * as closed to 16-bit RGB as possible, with or without an optional depth
     * buffer as closed to 16-bits as possible.
     * <p>If this method is
     * called, it must be called before {@link #setRenderer(Renderer)}
     * is called.
     * <p>
